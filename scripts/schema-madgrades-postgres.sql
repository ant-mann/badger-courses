...
CREATE TABLE madgrades_refresh_runs (
  madgrades_refresh_run_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE madgrades_courses (
  madgrades_course_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE madgrades_instructors (
  madgrades_instructor_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  display_name TEXT NOT NULL
);

CREATE TABLE madgrades_course_grades (
  madgrades_course_grade_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE madgrades_course_grade_distributions (
  madgrades_course_grade_distribution_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE madgrades_instructor_grades (
  madgrades_instructor_grade_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  madgrades_refresh_run_id INTEGER NOT NULL,
...
CREATE TABLE madgrades_instructor_grade_distributions (
  madgrades_instructor_grade_distribution_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE madgrades_course_offerings (
  madgrades_course_offering_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  madgrades_course_id INTEGER NOT NULL,
  madgrades_instructor_id INTEGER NOT NULL,
  term_code TEXT NOT NULL,
  section_type TEXT,
